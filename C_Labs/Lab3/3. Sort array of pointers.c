...
The function must sort the three pointers in the array so that the pointer to the smallest 
integer is the first element of the array and pointer to the largest integet is the last element of the array. The function may not modify the integer values.
